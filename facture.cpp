...
Facture::Facture(int id_facture, QString des, int type, QString date_facture, float prix_uni)//,int id_client,QString date_facture,QString des,float prix_uni,int quantite,float montant,QString mail_facture,int type)
{
   ...
   // this->mail_facture=mail_facture;
    this->type=type;
...
//QString Facture::getmail(){return mail_facture;}
...
//void Facture::setmail(QString mail){this->mail_facture=mail;}
...
bool Facture::ajouter(){
  ...
  //  QString quantite_string=QString::number(quantite);
   // QString montant_string=QString::number(montant);
    ...
    QSqlQuery query;
    query.prepare("INSERT INTO facture_2 (id_facture,des,type,date_facture,prix_uni)" //,id_client,date_facture,des,prix_uni,quantite,montant,mail_facture,type) "
                        "VALUES (:id_facture, :des, :type, :date_facture, :prix_uni)");//, :id_client, :date_facture, :des, :prix_uni, :quantite, :montant, :mail_facture, :type)");
    ...
    //    query.bindValue(":id_client", id_client_string);
      ...
      //    query.bindValue(":mail_facture", mail_facture);
