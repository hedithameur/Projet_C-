...
Personnel::Personnel()
{
    id=0;periode_conger=0; nom="";prenom="";mois_conger="";nombre_perso=0;
}
Personnel::Personnel(int id,int periode_conger,QString nom,QString prenom,QString mois_conger,int nombre_perso)
{
    this->id=id;
...
int Personnel::getnombreperso(){return nombre_perso;}
...
void Personnel::setnombreperso(int nombre_perso){this->nombre_perso=nombre_perso;}
...
bool Personnel::ajouter()
{
    ...
    query.prepare("INSERT INTO personnel (id,nom,prenom,periode_conger,mois_conger,nombre_perso)"
                  "VALUES (:id,:nom,:prenom,:periode_conger,:mois_conger,:nombre_perso)");
    ...
    query.bindValue(":nombre_perso",nombre_perso);
...
bool Personnel::modifier()
{
    ...
    query.prepare("UPDATE personnel set nom= :nom, prenom= :prenom,periode_conger= :periode_conger,mois_conger=:mois_conger,nombre_perso=:nombre_perso  where id= :id ");
...
QSqlQueryModel* Personnel::afficher()
{
    QSqlQueryModel* model=new QSqlQueryModel();
         ...
         // model->setHeaderData(3, Qt::Horizontal, QObject::tr("NOM TACHE"));
          ...
          model->setHeaderData(4, Qt::Horizontal, QObject::tr("Mois Conger"));
          model->setHeaderData(5, Qt::Horizontal, QObject::tr("Nombre_Perso"));
...
{
QSqlQueryModel * model = new QSqlQueryModel();
model ->setQuery("select * from personnel ORDER BY nom or prenom ");
model->setHeaderData(0, Qt::Horizontal, QObject::tr("NOM"));
model->setHeaderData(1, Qt::Horizontal, QObject::tr("PRENOM"));
model->setHeaderData(2, Qt::Horizontal, QObject::tr("ID"));
// model->setHeaderData(3, Qt::Horizontal, QObject::tr("NOM TACHE"));
